...
require (
	...
	github.com/redhat-developer/service-binding-operator v1.2.0 // indirect
...
replace sigs.k8s.io/controller-runtime => github.com/kcp-dev/controller-runtime v0.12.2-0.20221006162808-d4b60cec23b4
