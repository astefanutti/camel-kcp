...
// To be removed once https://github.com/kcp-dev/kcp/pull/2907 is available
replace (
	github.com/kcp-dev/kcp => github.com/astefanutti/kcp v0.0.0-20230320142546-52b527097b94
	github.com/kcp-dev/kcp/pkg/client => github.com/kcp-dev/kcp/pkg/client v0.0.0-20230317131701-60ba17a17808
)
